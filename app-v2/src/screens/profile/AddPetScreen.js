// ─────────────────────────────────────────────────────────────────────────────
// Pepete — AddPetScreen v3.0 — creation + edition + photo picker
// ─────────────────────────────────────────────────────────────────────────────
...
const GENDERS = [
  { key: 'male',    label: 'Male',    icon: '\u2642', color: '#8CB092', bg: '#EFF5F0' },
...
const AddPetScreen = ({ navigation, route }) => {
  ...
  const validate = () => {
    ...
    if (!species) e.species = 'Choisissez une espece';
    if (!gender) e.gender = 'Choisissez le genre';
    if (age && (isNaN(parseInt(age, 10)) || parseInt(age, 10) < 0)) e.age = 'Age invalide';
      ...
      >
        ...
        >
          ...
          <View style={styles.sectionCard}>
            ...
            {/* Espece */}
            <View style={styles.field}>
              <Text style={styles.label}>Espece <Text style={styles.required}>*</Text></Text>
                ...
                {GENDERS.map((g) => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      activeOpacity={0.7}
                    >
                      <Text style={[styles.genderIconText, active && { color: g.color }]}>{g.icon}</Text>
          ...
          <View style={styles.sectionCard}>
            ...
            <View style={styles.row}>
              <View style={[styles.field, styles.rowField]}>
                <Text style={styles.label}>Age (ans)</Text>
                <TextInput
                  ref={ageRef}
            ...
            <View style={[styles.switchRow, { marginBottom: 0 }]}>
              ...
              <View style={styles.switchInfo}>
                ...
                <Text style={styles.switchSub}>Vaccins a jour</Text>
              </View>
              <Switch
                value={vaccinated}
