        ...
        { text: 'Annuler', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              showAlert('Erreur', 'Impossible de supprimer cet animal.');
            } finally {
              setDeletingId(null);
            }
          },
            ...
            <View style={styles.chips}>
              ...
              {item.sterilized && (
                <View style={[styles.chip, styles.chipGreen]}>
                  ...
                  <Text style={[styles.chipText, { color: colors.success }]}>Sterilise</Text>
                </View>
              )}
            </View>
            {item.specialNeeds ? (
  ...
  const renderEmpty = () => (
    <View style={styles.emptyWrap}>
      ...
      <Text style={styles.emptySub}>
        Ajoutez votre premier compagnon{'\n'}pour commencer l'aventure Pepete
      </Text>
      <TouchableOpacity
