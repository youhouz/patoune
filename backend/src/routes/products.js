...
const { scanProduct, addProduct, getScanHistory, searchProducts, getPopularProducts, getCommunityStats, getAlternatives, getLeaderboard } = require('../controllers/productController');
