// ─────────────────────────────────────────────────────────────────────────────
// Pépète — OnboardingScreen v3.0
// DA : Apple × pépète brand — crème chaud, vert sauge, typographie Display
// ─────────────────────────────────────────────────────────────────────────────

import React, { useState, useRef, useEffect } from 'react';
import {
  View, Text, StyleSheet, TouchableOpacity,
  Platform, Animated, StatusBar, Dimensions, Pressable,
} from 'react-native';
...
const FeatureRow = ({ icon, text, delay }) => {
  ...
  useEffect(() => {
    anim.setValue(0); slide.setValue(14);
    const t = setTimeout(() => {
      Animated.parallel([
