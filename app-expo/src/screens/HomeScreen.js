...
const HomeScreen = ({ navigation }) => {
  ...
  const features = [
    ...
    },
    {
      icon: 'alert-triangle',
      title: 'Animal perdu',
      subtitle: 'Alertes geolocalisees',
      gradient: ['#C25B4A', '#D4855A'],
      onPress: () => navigation.navigate('LostPets'),
    },
    {
      icon: 'shield',
      title: 'Carnet sante',
      subtitle: 'Vaccins, poids, traitements',
      gradient: ['#527A56', '#8CB092'],
      onPress: () => navigation.navigate('Profil', { screen: 'MyPets' }),
    },
    {
      icon: 'briefcase',
      title: 'Pros animaux',
      subtitle: 'Veto, toiletteur, educateur',
      gradient: ['#6B8F71', '#527A56'],
