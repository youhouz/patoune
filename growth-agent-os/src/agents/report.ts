...
<head>
  ...
  <title>Growth Strategy Report - ${escapeHtml(appName)}</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      ...
      <div class="subtitle">${escapeHtml(appName)} - Generated by Growth Agent OS</div>
      <div class="app-url">${escapeHtml(url)}</div>
...
async function sendReport(
  ...
  try {
    ...
    await resend.emails.send({
      ...
      subject: `Growth Strategy Report - ${escapeHtml(appName)}`,
      html,
    });
